...
class RegPage(BasePage):
    # метод проверки расположения полей ввода, кнопки "Зарегистрироваться", ссылки на пользовательское соглашение
    ...
    # метод проверки работы текстового поля (ввод валидных данных)
    ...
    # метод проверки работы полей ввода email или мобильного телефона (ввод валидных данных)
    ...
    # метод проверки работы поля ввода пароля (ввод валидных данных)
    ...
    # метод проверки регистрации с валидными данными
    ...
    # метод проверки ссылки на страницу с пользовательским соглашением под кнопкой "Зарегистрироваться"
    ...
    # метод проверки ссылки на страницу с пользовательским соглашением в футере
    def link_foot_to_the_user_agreement_page(self):
        original_window = self.browser.current_window_handle
        assert len(self.browser.window_handles) == 1
    ...
    # метод проверки работы текстового поля (ввод невалидных данных)
    ...
    # метод проверки работы поля ввода email или мобильного телефона (ввод невалидных данных)
    ...
    # метод проверки работы поля ввода пароля (ввод невалидных данных)
    ...
    # метод проверки заполнения поля подтверждения пароля данными, отличными от введенных в поле ввода пароля
    ...
    # метод проверки регистрации с невалидными данными
